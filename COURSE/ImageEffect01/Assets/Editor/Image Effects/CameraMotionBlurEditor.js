...
{	
  ...
  var serialPreview : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    serialPreview = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (this.serialPreview, new GUIContent("Preview"));
    if (this.serialPreview.boolValue)
