...
public class CameraScrollingCS : MonoBehaviour {
	...
	private LevelAttributesCS levelAttributes = new LevelAttributesCS() ;
	...
	Vector3 GetGoalPosition () {
		...
		CameraTargetAttributesCS cameraTargetAttributes = target.GetComponent<CameraTargetAttributesCS>() ;
		...
		PlatformerControllerCS targetPlatformerController = target.GetComponent<PlatformerControllerCS>() ;
